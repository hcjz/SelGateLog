...
//  FAcceptExSocket := TIOCPAccepter.Create(MAX_LOGIN_USER, FUserList);
  ...
  FUserList := TUserManager.Create(10);
 //FSendSocket := TIOCPWriter.Create(10, FUserList);
  //FRecvSocket := TIOCPReader.Create(10, FSendSocket, FUserList);
  //FAcceptExSocket := TIOCPAccepter.Create(10, FUserList);
end;
